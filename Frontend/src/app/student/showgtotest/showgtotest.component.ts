...
@Component({
  selector: 'app-showgtotest',
  templateUrl: './showgtotest.component.html',
  styleUrl: './showgtotest.component.css'
})
export class ShowgtotestComponent {
